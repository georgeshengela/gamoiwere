...
function App() {
  ...
  const [authSidebarView, setAuthSidebarView] = useState<'login' | 'register'>(
    'login'
  );
        ...
        <>
          ...
          <Suspense fallback={<PageLoader />}>
            <Switch>
              ...
              />
              <Route
                path="/admin/sms-notifications"
                component={SmsNotificationsPage}
              />
              <Route path="/admin/monitoring" component={AdminMonitoringPage} />
              <Route
                path="/admin/api-service"
                component={AdminApiServicePage}
              />
              <Route
                path="/admin/site-statistics"
                component={SiteStatisticsPage}
              />
              <Route
                path="/admin/category-progress"
