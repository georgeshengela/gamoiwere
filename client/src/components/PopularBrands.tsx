    ...
    <section className="mb-8 md:mb-12">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-[16px] md:text-[20px] font-bold text-gray-900 uppercase" style={{ fontFamily: 'MarkGEOCAPS-Regular, sans-serif' }}>
            პოპულარული ბრენდები
          </h2>
        </div>
        <Link 
            ...
            <div className="aspect-square flex items-center justify-center">
              <img 
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    parent.innerHTML = `<div class="w-full h-full flex items-center justify-center bg-primary/10 rounded-lg text-primary font-bold text-xs">${brand.name.charAt(0)}</div>`;
                  }
                }}
              />
            </div>
      ...
      <div className="mt-4 text-center">
        <p className="text-sm text-gray-600">
          შეუკვეთეთ თქვენი საყვარელი ბრენდების პროდუქტები მსოფლიოს ნებისმიერი ქვეყნიდან
        </p>
      </div>
    </section>
  );
